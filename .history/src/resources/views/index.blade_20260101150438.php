    ...
    <form class="form">
        <div class="form-content">
            <div class="form-content-name">
                ...
                <span class="form-content-name_re">必須</span>
            </div>
        ...
        <div class="form-content">
            <div class="form-content-email">
                ...
                <span class="form-content-email_re">必須</span>
            </div>
            <div class="form-email_create">
        ...
        <div class="form-content">
            <div class="form-content-tel">
                ...
                <span class="form-content-tel_re">必須</span>
            </div>
            <div class="form-tel_create">
                <input type="text" name="tel" value="09012345678">
            </div>
        </div>
        <div class="form-content">
            ...
            <div class="form-text_create">
                <textarea name="text" value="資料をいただきたいです"></textarea>
            </div>
